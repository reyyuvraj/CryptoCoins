...
import tech.reyyuvraj.cryptocoins.presentation.coin_detail.components.CoinTag
import tech.reyyuvraj.cryptocoins.presentation.coin_detail.components.TeamListItem
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        state.coin?.let { coin ->
            LazyColumn(
                ...
                items(coin.team as List<CoinDetailDto.TeamMember>) { teamMember ->
                    TeamListItem(
